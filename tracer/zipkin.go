...
// WrapZipkinOpenTracing wraps the given zipkin consumer with OpenTracing
func WrapZipkinOpenTracing(cfg *config.Kernel, zipTracer *zipkin.Tracer) stdopentracing.Tracer {
